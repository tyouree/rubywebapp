...
ActiveRecord::Schema.define(version: 2022_05_01_010101) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "user_masters", id: :serial, force: :cascade do |t|
    ...
    t.integer "user_level", limit: 2, null: false, comment: "ユーザ権限"
